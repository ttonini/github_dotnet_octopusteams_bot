...
namespace OctopusBot.Dialogs
{
    public class AuthenticationDialog : ComponentDialog
    {
        ...
        public AuthenticationDialog(IOptions<AppSettings> settings)
        {
            ...
            AddDialog(new OAuthPrompt(
                ...
                {
                    ConnectionName = _settings.Authentication.ConnectionName,
                    Text = "Please Sign In",
                    Title = "Sign In",
            ...
            {
                //Start of Auth connection code that will be its own dialog
                PromptStepAsync,
                LoginStepAsync,
                DisplayTokenPhase1Async,
                DisplayTokenPhase2Async,
                //End Auth connection code
            }));
        }
